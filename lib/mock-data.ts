...
export const messages: Message[] = [
  { id: "m1", name: "Juliana Souza", avatar: "https://i.pravatar.cc/96?img=47", time: "14:32", preview: "Consegue me enviar os materiais?", body: "Daniel, consegue me enviar os materiais atualizados da campanha? Quero revisar antes de repassar para o time comercial.", role: "Supervisora Comercial", hierarchy: "Liderança · Nível 4", unread: 2 },
